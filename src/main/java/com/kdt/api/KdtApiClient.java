...
public class KdtApiClient {
    ...
    public CloseableHttpResponse get(String method, HashMap<String,String> parames) throws Exception{
    ...
    public CloseableHttpResponse post(String method, HashMap<String, String> parames, List<String> filePaths, String fileKey) throws Exception{
    	String url = apiEntry + getParamStr(method, parames);
    	...
    	if(null != filePaths && filePaths.size() > 0 && null != fileKey && !"".equals(fileKey)){
	    	...
	    	for(int i = 0; i < filePaths.size(); i++){
	    		...
	    		builder.addPart(fileKey, cbFile);
	    	}
